...
{
	var highscores_dialog = new MateGamesSupport.ScoresDialog.c_new(
...
highscores = new MateGamesSupport.Scores.c_new("swell-foop", null,
                                                null, "board size", null, 0,
                                MateGamesSupport.ScoreStyle.PLAIN_DESCENDING);
