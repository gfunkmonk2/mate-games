...
if(MateGamesSupport.setgid_io_init)
	MateGamesSupport.setgid_io_init();

MateGamesSupport.runtime_init("swell-foop");
MateGamesSupport.Conf.initialise("swell-foop");
...
handlers = {
	...
	{
		MateGamesSupport.help_display(window, "swell-foop", null);
	},
...
MateGamesSupport.Conf.shutdown();
