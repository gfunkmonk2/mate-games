/*
 * Copyright © 2007 Andreas Røsdal <andreasr@mate.org>
...
static const DerivedDirectory derived_directories[] = {
  ...
  { GAMES_RUNTIME_DATA_DIRECTORY,     "mate-games-common" }, /* GAMES_RUNTIME_COMMON_DATA_DIRECTORY       */
  { GAMES_RUNTIME_DATA_DIRECTORY,     "mate-games"        }, /* GAMES_RUNTIME_PKG_DATA_DIRECTORY          */
 ...
 * and initialises gettext support and mate-games debug support.
 *
...
#if defined(HAVE_MATE) || defined(HAVE_RSVG_MATEVFS) || defined(ENABLE_SOUND)
  /* If we're going to use mateconf, mate-vfs, or canberra, we need to
...
games_runtime_get_directory (GamesRuntimeDirectory directory)
{
  ...
  switch ((int) directory) {
    ...
    case GAMES_RUNTIME_COMMON_DATA_DIRECTORY:
      path = g_build_filename (DATADIR, "mate-games-common", NULL);
      break;
