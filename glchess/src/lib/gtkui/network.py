...
class GtkNetworkAddDialog:
    ...
    def __init__(self, networkDialog, parent):
        ...
        self.serverModel.set(self.serverModel.append(), 0, _("GGZ Gaming Zone"), 1, "mate.ggzgamingzone.org", 2, 5688)
    ...
    def addRoom(self, index, name, nPlayers, description, room, protocol):
        ...
        try:
            (icon, isSupported) = {None:       ('stock_people', True),
                                   'Chess':    ('mate-glchess', True),
                                   'Reversi':  ('mate-iagno', False),
                                   'GGZCards': ('mate-aisleriot', False),
                                   'Gnect':    ('mate-gnect', False),
                                   'Gnibbles': ('mate-gnibbles', False),
