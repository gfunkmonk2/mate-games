...
from gtk_goodies import mateconf_wrapper
from gettext import gettext as _
from gettext import ngettext
import threading

class GameGenerator (mateconf_wrapper.MateConfWrapper):
    ...
    def __init__ (self, UI, mateconf):
        ...
        for d in ['easy',
            ...
            mateconf_setting = 'generate_target_%s' % d
            self.mateconf_wrap_toggle(mateconf_setting, widget)
        ...
        self.mateconf_wrap_toggle('generate_endlessly', self.generateEndlesslyRadio)
        self.mateconf_wrap_toggle('generate_for_target', self.generateForTargetRadio)
        ...
        self.mateconf_wrap_adjustment('number_of_sudokus_to_generate',
