...
class GamePrinter (mateconf_wrapper.MateConfWrapper):
    ...
    def __init__ (self, sudoku_maker, mateconf):
        ...
        for key, wname in [('mark_printed_as_played', 'markAsPlayedToggle'),
            ...
            self.mateconf_wrap_toggle(key, getattr(self, wname))
        ...
        for key, widg in [('print_multiple_sudokus_to_print', self.sudokusToPrintSpinButton.get_adjustment()),
            ...
            self.mateconf_wrap_adjustment(key, widg)
