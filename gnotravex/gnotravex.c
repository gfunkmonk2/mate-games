...
static const char *translatable_number[10] = {
  /* Translators: in-game numbers, replaceable with single-character local ideomrams */
  NC_("number", "0"),
  NC_("number", "1"),
  NC_("number", "2"),
  NC_("number", "3"),
...
main (int argc, char **argv)
{
  ...
  gtk_window_set_default_icon_name ("mate-tetravex");
